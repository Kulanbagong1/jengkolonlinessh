...
# ==================================================
# Link Hosting Kalian
jengkolonlinevpn="raw.githubusercontent.com/fisabiliyusri/Mantap/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${jengkolonlinevpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${jengkolonlinevpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${jengkolonlinevpn}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${jengkolonlinevpn}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${jengkolonlinevpn}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${jengkolonlinevpn}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
