...
```html
rm -f setup.sh && apt update && apt upgrade -y && update-grub && sleep 2 && apt-get update -y && apt-get upgrade && sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/Kulanbagong1/jengkolonlinessh/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
###. Edit Port SSL WS atau Ganti Port SSL(Manual)
...
• OpenSSH                   : 443, 22, 59, 2253

• Dropbear                  : 443, 22, 109, 143, 1153
...
• Websocket SSH HTTP        : 80, 8880

• Websocket OpenVPN         : 443
